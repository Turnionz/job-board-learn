...
class MyJobController extends Controller
{
     ...
     */
    public function store(JobRequest $request, Job $myJob)
    {
    ...
    public function update(JobRequest $request, Job $myJob)
    {
        ...
        return redirect()->route('my_jobs.index')->with('success', 'Job posting was updated successfully!');
    }
    ...
    public function destroy(Job $myJob)
    {
        ...
        return redirect()->route('my_jobs.index')->with('success', 'Job posting deleted successfully!');
    }
}
